...
--
-- Table structure for table `user_tweets_realdonaldtrump`
--

DROP TABLE IF EXISTS `user_tweets_realdonaldtrump`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `user_tweets_realdonaldtrump` (
...
-- Dump completed on 2020-03-22 15:19:07
